...
// Legacy preset system removed - use NodeCharacter library instead
// See NodeCharacter.h/cpp for unified character/preset system
...
// Legacy preset API removed - use CharacterManager and NodeCharacter library instead
