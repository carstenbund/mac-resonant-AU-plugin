...
/**
 * @brief Character 15: Bach-T1 Soprano
 *
 * Well-tempered soprano voice for fugal textures.
 * Clear subject line with living temperament offsets.
 * Historically-informed narrowed fifth (-2 cents).
 */
extern const NodeCharacter CHARACTER_BACH_T1_SOPRANO;

/**
 * @brief Character 16: Bach-T2 Alto
 *
 * Well-tempered alto with key color.
 * Expressive minor third temperament (+4 cents).
 * Baroque reed character with fourth suspensions.
 */
extern const NodeCharacter CHARACTER_BACH_T2_ALTO;

/**
 * @brief Character 17: Bach-T3 Tenor
 *
 * Well-tempered tenor with controlled grit.
 * Strongest temperament pressure (-8 cent fifth).
 * Engine room for mechanical counterpoint brilliance.
 */
extern const NodeCharacter CHARACTER_BACH_T3_TENOR;

/**
 * @brief Character 18: Bach-T4 Bass
 *
 * Well-tempered bass foundation.
 * Baroque organ pillar with sub-octave gravity.
 * Lawful temperament, most stable voice.
 */
extern const NodeCharacter CHARACTER_BACH_T4_BASS;

/**
 * @brief Character library array for indexed access
 *
 * Maps character ID (0-18) to character definition.
 */
extern const NodeCharacter* CHARACTER_LIBRARY[19];

/**
 * @brief Number of built-in characters
 */
#define NUM_BUILTIN_CHARACTERS 19
